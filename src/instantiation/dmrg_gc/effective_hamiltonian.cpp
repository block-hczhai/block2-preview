...
template struct block2::LinearEffectiveHamiltonian<block2::SGF,
                                                   complex<float>>;
template struct block2::EffectiveHamiltonian<
    block2::SGF, complex<float>,
    block2::MultiMPS<block2::SGF, complex<float>>>;

template struct block2::EffectiveHamiltonian<
    block2::SGB, complex<float>, block2::MPS<block2::SGB, complex<float>>>;
template struct block2::LinearEffectiveHamiltonian<block2::SGB,
                                                   complex<float>>;
template struct block2::EffectiveHamiltonian<
    block2::SGB, complex<float>,
    block2::MultiMPS<block2::SGB, complex<float>>>;
