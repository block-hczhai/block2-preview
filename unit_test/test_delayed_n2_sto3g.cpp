...
template <typename FL> class TestDelayedN2STO3G : public ::testing::Test {
  protected:
    size_t isize = 1LL << 24;
    size_t dsize = 1LL << 28;
    ...
    void SetUp() override {
        ...
        threading_() = make_shared<Threading>(
            ThreadingTypes::OperatorBatchedGEMM | ThreadingTypes::Global, 2, 1,
            2);
...
template <typename S>
void TestDelayedN2STO3G<FL>::test_dmrg(
    ...
    hamil->delayed = DelayedOpNames::H | DelayedOpNames::Normal |
                     DelayedOpNames::P | DelayedOpNames::PD |
                     DelayedOpNames::R | DelayedOpNames::RD | DelayedOpNames::Q;
...
TYPED_TEST_CASE(TestDelayedN2STO3G, TestFL);

TYPED_TEST(TestDelayedN2STO3G, TestSU2) {
    using FL = TypeParam;
...
TYPED_TEST(TestDelayedN2STO3G, TestSZ) {
    using FL = TypeParam;
    using FLL = typename GMatrix<FL>::FL;
