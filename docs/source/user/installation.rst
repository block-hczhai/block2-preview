...
* To install the most recent development version, use: ::
  ...
  where ``<version>`` can be some development version number like ``0.5.4rc17`` (see https://github.com/block-hczhai/block2-preview/tags
  ...
  with macOS (arm64), Linux (x86_64 and aarch64), or Windows (x86_64) with no MPI dependence, and Linux (x86_64) with openMPI.
